...
    if (amt === null || amt === undefined) return 2000;
...
          text: `Invoice details for ${tx?.type || "Transaction"} of ${
            tx?.amount || 0
          } on ${tx?.date || ""}`,
...
                  <div className="invoice-meta-val">
                    {getInvoiceNumber()}
                  </div>
                </div>
...
                <div className="bar-item-val">
                  {getBillingPeriod(tx?.date)}
                </div>
              </div>
            </div>
