                ...
                <div className="BillingPlans_header">
                    ...
                    <div className="BillingPlans_header-right">
                        <div className="BillingPlans_mode-toggle">
                            <button className="BillingPlans_mode-btn">⚡ Test</button>
                            <button className="BillingPlans_mode-btn active">⚡ Live</button>
                        </div>
                        <button className="BillingPlans_add-balance-main-btn" onClick={() => setIsSliderOpen(true)}>+ Add Balance</button>
                    </div>
                </div>
            </div>
                ...
                <div className="BillingPlans_transactions-section">
                    <div className="BillingPlans_section-header">
                        ...
                        <div className="BillingPlans_custom-dropdown-container">
                            ...
                            >
                                {selectedDateRange} <span className="BillingPlans_arrow">▼</span>
                            </button>
                            {dateDropdownOpen && (
                        ...
                        <tbody>
                            {transactions.map((tx, idx) => (
                                <tr key={idx}>
                                    ...
                                    <td>{tx.amount}</td>
                                    <td>
                                        <span className="BillingPlans_status-pill completed">{tx.status}</span>
                                    </td>
                                    <td>
                                        <button className="BillingPlans_download-btn">⬇</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                ...
                <div className="BillingPlans_sidebar-section">
                    <div className="BillingPlans_sidebar-card BillingPlans_plan-history">
                            ...
                            <div className="BillingPlans_timeline-item">
                                ...
                                <div className="BillingPlans_timeline-content">
                                    <div className="BillingPlans_timeline-header-row">
                                        ...
                                        <span className="BillingPlans_badge purple-solid">Active</span>
                                    </div>
                                    <p className="BillingPlans_timeline-date">May 28, 2022 → Active</p>
                                </div>
                            </div>
                       ...
                       Usually the line connects FROM this dot downwards. The last one doesn't need a line going down. */}
                                <div className="BillingPlans_timeline-content">
                                    ...
                                    <p className="BillingPlans_timeline-date">Feb 28, 2022 → May 28, 2022</p>
                                </div>
                            </div>
                    ...
                    <div className="BillingPlans_sidebar-card BillingPlans_auto-recharge">
                        <div className="BillingPlans_card-header-toggle">
                            <h3>Auto-recharge</h3>
                            <div className="BillingPlans_switch" onClick={() => setAutoRecharge(!autoRecharge)}>
                                <input
                                    type="checkbox"
                        ...
                        <div className="BillingPlans_recharge-input-group">
                            <div className="BillingPlans_input-wrapper">
                                <span className="BillingPlans_currency-img">▶️</span>
                                ...
                                />
                                <button className="BillingPlans_pay-small-btn" onClick={handleTopUp}>pay</button>
                            </div>
                        </div>
                    ...
                    <div className="BillingPlans_sidebar-card BillingPlans_usage-alerts">
                        <div className="BillingPlans_card-header-toggle">
                            <h3>Usage Alerts</h3>
                            <div className="BillingPlans_switch" onClick={() => setUsageAlerts(!usageAlerts)}>
                                <input
                                    type="checkbox"
                                    checked={usageAlerts}
                                    readOnly
                ...
                <div className="BillingPlans_slider-overlay">
                    <div className="BillingPlans_slider-container">
                        <div className="BillingPlans_slider-header">
                            <h2>Add Money</h2>
                            <button className="BillingPlans_close-btn" onClick={() => setIsSliderOpen(false)}>×</button>
                        </div>
