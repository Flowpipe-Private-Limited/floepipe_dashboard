...
//         const botResponse = {
//           id: Date.now() + 1,
//           text: "We have a Prepaid recharge model and you will be charged on each API call basis for the successful transaction. Per transaction cost of each service depends on the plan you avail.",
//           sender: "bot",
//           timestamp: new Date(),
//         };
...
//                     <div className="help-chat-messages-container">
//                       {chatMessages.map((msg) => (
//                         <div
//                           key={msg.id}
//                           className={`help-chat-message ${
//                             msg.sender === "user" ? "user" : "bot"
//                           }`}
//                         >
//                           {msg.sender === "bot" && (
//                             <div className="help-chat-avatar">
//                               <div className="help-avatar-circle"></div>
//                             </div>
//                           )}
//                           <div className="help-chat-bubble">
//                             <p className="help-chat-text">{msg.text}</p>
//                           </div>
//                         </div>
//                       ))}
//                     </div>
//                     <div className="help-chat-input-footer">
//                       <input
//                         type="text"
//                         placeholder="Message.."
//                         className="help-chat-footer-input"
//                         value={message}
//                         onChange={(e) => setMessage(e.target.value)}
//                         onKeyPress={handleKeyPress}
//                       />
//                       <button 
//                         className="help-chat-footer-send"
//                         onClick={handleSendMessage}
//                       >
...
const Help = ({ onClose }) => {
  ...
  // Determine header class based on current view
  const getHeaderClass = () => {
    if (showLiveChat) {
      if (chatMessages.length > 0) {
        return "help-modal-header-chatting"; // Active chat
      }
      return activeTab === "home" 
        ? "help-modal-header-livechat" 
        : "help-modal-header-messages";
    }
    if (showContact) return "help-modal-header-contact";
    if (selectedFaq) return "help-modal-header-faq";
    return "help-modal-header-main";
  };
      ...
      >
            ...
            <div className="help-header-nav">
              {showLiveChat ? (
                activeTab === "home" ? (
                  ...
                  <div className="help-modal-header-mess">
                    <h2 style={{color:'black'}} className="help-chat-title help-chat-title-center">
                      Messages
                    </h2>
                  </div>
                )
        ...
        >
          {showLiveChat ? (
            ...
            <div className="help-contact-view">
              {/* Still have Questions? */}
               <div className="Content-inside-one">
              <div className="help-questions-section">
                <h3 className="help-questions-title">Still have Questions?</h3>
                <p className="help-questions-subtitle">
                  Ask our team of experts any questions. available 24/7.
        ...
        {/* Bottom Navigation Tabs - Only show in Live Chat when NOT actively chatting */}
        {showLiveChat && chatMessages.length === 0 && (
          <div className="help-chat-bottom-nav">
            <button
              className={`help-nav-tab ${activeTab === "home" ? "active" : ""}`}
              onClick={() => setActiveTab("home")}
            ...
            <button
              ...
              onClick={() => setActiveTab("messages")}
            >
              <img src={Images.msgicon} className="help-messages-empty-icon-nav" alt="Messages" />
              <span>Messages</span>
            </button>
          </div>
        )}
